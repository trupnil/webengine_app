  <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><img src="<?php echo base_url() ?>resource/assets/images/users/profile.png" alt="user" /><span class="hide-menu"><?php echo $this->session->userdata('user_name'); ?> </span></a>
