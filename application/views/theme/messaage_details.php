...
<!-- Mirrored from wrappixel.com/demos/admin-templates/admin-pro/dark/app-email-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Dec 2018 06:35:17 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xlg-10 col-lg-9 col-md-8 bg-light-part b-l">
                                    ...
                                    <div class="card-body p-t-0">  
                                        <?php   foreach ($full_message as $key => $value) {
                                            ?>
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex m-b-40">
                                                    ...
                                                    <div class="p-l-10">
                                                        <h4 class="m-b-0">From : <?php echo $value->sender_id ?></h4>
                                                        </div>
                                                </div>
                                                <p> <?php echo $value->messge_text; ?> </p>
                                                 </div>
                                            <div>
                                                <hr class="m-t-0">
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <a href="<?php echo base_url() ?>resource/<?php echo $value->attachement; ?>" download> Attachment download  
                                                        <embed src="<?php echo base_url() ?>resource/<?php echo $value->attachement; ?>" >  </embed>
